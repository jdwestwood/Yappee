...
// request with the client.
  if (epoPatList != "") {
    ...
    // set clientCookie; need to specify domain if not the domain of the page that is currently loaded.
    cookieTracker.start({domain: EPO_QUERY_DOMAIN, path: EPO_QUERY_PATH});
    $.ajax({ type: "POST",
