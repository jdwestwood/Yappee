...
// process the content of a search page
  ...
  // get rid of occasional Wikipedia links and associated elements
  $("li.g", $context).each(deleteNonPatents);
  $("li.normal-footer, li.normal-footer + hr.rgsep", $context).remove();

  // remove the translate links; use .contents() to get both html and text nodes
  $("li.g div.s cite", $context).closest("div").contents().filter(function() {return this.nodeName != "CITE";}).remove();
